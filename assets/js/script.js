...
/**
 * Checks the answer against the first element in the return
...
function checkAnswer() {
  ...
  if (isCorrect) {
    ...
    alert(
      `Ah. you answered ${userAnswer}. The answer was ${calculatedAnswer[0]}`
    );
...
function displayDivisionQuestion(operand1, operand2) {
  ...
  document.getElementById("operand1").textContent = multiply;
  document.getElementById("operand2").textContent = operand2;
  document.getElementById("operator").textContent = "/";
}
